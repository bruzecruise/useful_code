...
# concatinates aligned fasta files into a supermatrix and prints partition file
# uses string before first defined delimiter to create ID
# run by: python concatinate.py -in *.fasta -d "_"
# only works with python 2, need to update the dict.keys = they don't return a list in python 3
# modified from partBreaker.py
# https://github.com/ballesterus/Utensils/blob/master/partBreaker.py
